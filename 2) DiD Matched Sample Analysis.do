...
*insert data
use "2) DiD Matched Sample.dta", clear

xtset school_id year


*Figure 2
xtevent complaints, policy(treatment3) window(7) cl(_id)
xteventplot, nosupt  noprepval nopostpval ytitle("Complaints, β") xtitle("Year")


*Table B:1. Parallel trends assumption
...
*Tabl 7. Results: Difference-in-Difference Analysis
