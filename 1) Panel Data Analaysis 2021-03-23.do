...
*insert data
use "Dataset 2021-03-23.dta", clear


*Descriptives and correlations
mkcorr complaints disorder violence jh_GPA jh_herf jh_density jh_sistud jh_forbac jh_edupar minclog crime orgform jh_ctea jh_sctea s_sizelog if school_type==1 & year>1998, log("corr1.txt") cdec(3) mdec(3) lab means num casewise replace
